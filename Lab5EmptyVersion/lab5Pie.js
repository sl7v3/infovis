...
function drawPie(salaryData,projectList,pieSvg){
    ...
    var tip = d3.tip()
          ...
          .offset([-10, 0])
          .html(function(d,i) {
            return "<strong>"+Object.getOwnPropertyNames(employee)[i+1]+"</strong> <span style='color:red'>" +": "+d.data+ "</span>";//your work here */
          })
    ...
    for (idx in salaryData){
        ...
        aPieChart.append("text")
                 ...
                 .attr("y",cy+radius+pieOffset)//your work here //set the title on the bottom of the subchart. 
